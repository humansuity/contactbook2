...
import net.gas.gascontact.view.adapters.DepartmentListAdapter
...
class DepartmentListFragment : Fragment() {
    ...
    private lateinit var listAdapter: DepartmentListAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        departmentList?.let {
            listAdapter = DepartmentListAdapter(viewModel)
